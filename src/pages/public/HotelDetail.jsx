...
import { Star, MapPin, Check, ShieldCheck, Heart, Sparkles, Phone, Mail, Building2, X, ChevronLeft, ChevronRight, Image as ImageIcon, MessageSquare, ThumbsUp, Award, Quote, ArrowRight } from 'lucide-react';
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div>
                <div className="flex items-center gap-2">
                  ...
                  <span className="badge badge-gold font-extrabold text-xs flex items-center gap-1">
                    <Star className="w-3 h-3 fill-amber-400 text-amber-400" /> {hotel.rating || 4.9}
                  </span>
                </div>
              ...
              <div className="p-6 text-center space-y-4">
                ...
                <div className="pt-3 flex gap-2 justify-center">
                  ...
                  <Link 
                    ...
                    className="px-5 py-2.5 rounded-xl bg-amber-600 hover:bg-amber-700 text-white font-extrabold text-xs cursor-pointer shadow-lg shadow-amber-600/20 transition-all flex items-center gap-1.5"
                  >
                    <span>Open Messages Portal</span>
              ...
              <form 
                onSubmit={async (e) => {
                  ...
                  try {
                    ...
                    // safe fallback on submit message
                  }
                }} 
